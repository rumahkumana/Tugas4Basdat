...
CREATE TABLE `alat` (
  `Kode_Trans_Alat` int(11) NOT NULL,
  PRIMARY KEY (`Kode_Trans_Alat`)
...
INSERT INTO `alat` VALUES (1101),(1102),(1103),(1104),(1105),(1106),(1107),(1108),(1109),(1110),(1111),(1112),(1113),(1114),(1115),(1116),(1117),(1118),(1119),(1120),(1121),(1122),(1123),(1124),(1125),(1126),(1127),(1128),(1129),(1130),(1131),(1132),(1133),(1134),(1135),(1136),(1137),(1138),(1139),(1140),(1141),(1142),(1143),(1144),(1145),(1146),(1147),(1148),(1149),(1150),(1151),(1152),(1153),(1154),(1155),(1156),(1157),(1158),(1159),(1160),(1161),(1162),(1163),(1164),(1165),(1166),(1167),(1168),(1169),(1170),(1171),(1172),(1173),(1174),(1175),(1176),(1177),(1178),(1179),(1180),(1181),(1182),(1183),(1184),(1185),(1186),(1187),(1188),(1189),(1190),(1191),(1192),(1193),(1194),(1195),(1196),(1197),(1198),(1199),(1200);
...
--
-- Table structure for table `isi_tanggung_jawab`
--

DROP TABLE IF EXISTS `isi_tanggung_jawab`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `isi_tanggung_jawab` (
  `Nama_Departemen` varchar(24) NOT NULL,
  `ID_Prlkp` int(11) NOT NULL,
  `Kode_Trs_Alt` int(11) NOT NULL,
  PRIMARY KEY (`Nama_Departemen`,`ID_Prlkp`,`Kode_Trs_Alt`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `isi_tanggung_jawab`
--

LOCK TABLES `isi_tanggung_jawab` WRITE;
/*!40000 ALTER TABLE `isi_tanggung_jawab` DISABLE KEYS */;
INSERT INTO `isi_tanggung_jawab` VALUES ('Ilmu Kesehatan Anak',101,1101),('Ilmu Kesehatan Anak',103,1103),('Ilmu Kesehatan Anak',108,1108),('Ilmu Kesehatan Anak',112,1112),('Ilmu Kesehatan Anak',126,1126),('Ilmu Kesehatan Anak',127,1127),('Ilmu Kesehatan Anak',128,1128),('Ilmu Kesehatan Anak',132,1132),('Ilmu Kesehatan Anak',133,1133),('Ilmu Kesehatan Anak',144,1144),('Ilmu Kesehatan Anak',149,1149),('Ilmu Kesehatan Anak',156,1156),('Ilmu Kesehatan Anak',158,1158),('Ilmu Kesehatan Anak',169,1169),('Ilmu Kesehatan Anak',170,1170),('Ilmu Kesehatan Anak',171,1171),('Ilmu Kesehatan Anak',174,1174),('Ilmu Kesehatan Anak',180,1180),('Ilmu Kesehatan Anak',182,1182),('Ilmu Kesehatan Anak',196,1196),('Ilmu Kesehatan Anak',199,1199),('Ilmu Kesehatan Mata',116,1116),('Ilmu Kesehatan Mata',129,1129),('Ilmu Kesehatan Mata',138,1138),('Ilmu Kesehatan Mata',146,1146),('Ilmu Kesehatan Mata',166,1166),('Ilmu Kesehatan Mata',172,1172),('Ilmu Kesehatan Mata',173,1173),('Ilmu Kesehatan Mata',179,1179),('Ilmu Kesehatan Mata',181,1181),('Ilmu Kesehatan Mata',188,1188),('Ilmu Kesehatan Mata',192,1192),('Ilmu Penyakit Dalam',104,1104),('Ilmu Penyakit Dalam',105,1105),('Ilmu Penyakit Dalam',109,1109),('Ilmu Penyakit Dalam',114,1114),('Ilmu Penyakit Dalam',117,1117),('Ilmu Penyakit Dalam',118,1118),('Ilmu Penyakit Dalam',120,1120),('Ilmu Penyakit Dalam',130,1130),('Ilmu Penyakit Dalam',136,1136),('Ilmu Penyakit Dalam',139,1139),('Ilmu Penyakit Dalam',141,1141),('Ilmu Penyakit Dalam',150,1150),('Ilmu Penyakit Dalam',152,1152),('Ilmu Penyakit Dalam',153,1153),('Ilmu Penyakit Dalam',155,1155),('Ilmu Penyakit Dalam',159,1159),('Ilmu Penyakit Dalam',163,1163),('Ilmu Penyakit Dalam',167,1167),('Ilmu Penyakit Dalam',175,1175),('Ilmu Penyakit Dalam',176,1176),('Ilmu Penyakit Dalam',185,1185),('Ilmu Penyakit Dalam',190,1190),('Ilmu Penyakit Dalam',193,1193),('Ilmu Penyakit Dalam',197,1197),('Kebidanan dan Kandungan',102,1102),('Kebidanan dan Kandungan',121,1121),('Kebidanan dan Kandungan',122,1122),('Kebidanan dan Kandungan',134,1134),('Kebidanan dan Kandungan',137,1137),('Kebidanan dan Kandungan',142,1142),('Kebidanan dan Kandungan',143,1143),('Kebidanan dan Kandungan',151,1151),('Kebidanan dan Kandungan',154,1154),('Kebidanan dan Kandungan',161,1161),('Kebidanan dan Kandungan',162,1162),('Kebidanan dan Kandungan',165,1165),('Kebidanan dan Kandungan',168,1168),('Kebidanan dan Kandungan',189,1189),('Kebidanan dan Kandungan',194,1194),('Kebidanan dan Kandungan',195,1195),('Nama',106,1106),('Nama',110,1110),('Nama',113,1113),('Nama',119,1119),('Nama',135,1135),('Nama',148,1148),('Nama',157,1157),('Nama',177,1177),('Nama',178,1178),('Nama',186,1186),('Nama',187,1187),('Nama',200,1200),('Telinga Hidung Tenggorok',107,1107),('Telinga Hidung Tenggorok',111,1111),('Telinga Hidung Tenggorok',115,1115),('Telinga Hidung Tenggorok',123,1123),('Telinga Hidung Tenggorok',124,1124),('Telinga Hidung Tenggorok',125,1125),('Telinga Hidung Tenggorok',131,1131),('Telinga Hidung Tenggorok',140,1140),('Telinga Hidung Tenggorok',145,1145),('Telinga Hidung Tenggorok',147,1147),('Telinga Hidung Tenggorok',160,1160),('Telinga Hidung Tenggorok',164,1164),('Telinga Hidung Tenggorok',183,1183),('Telinga Hidung Tenggorok',184,1184),('Telinga Hidung Tenggorok',191,1191),('Telinga Hidung Tenggorok',198,1198);
/*!40000 ALTER TABLE `isi_tanggung_jawab` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `no_telpon_dokter`
--

DROP TABLE IF EXISTS `no_telpon_dokter`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `no_telpon_dokter` (
  `ID_Dokter` int(20) NOT NULL,
  `No_Telp_Dok` varchar(25) NOT NULL,
  PRIMARY KEY (`ID_Dokter`,`No_Telp_Dok`),
  CONSTRAINT `FK_No_Telpon_Dokter_Dokter` FOREIGN KEY (`ID_Dokter`) REFERENCES `dokter` (`ID_Dokter`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `no_telpon_dokter`
--

LOCK TABLES `no_telpon_dokter` WRITE;
/*!40000 ALTER TABLE `no_telpon_dokter` DISABLE KEYS */;
INSERT INTO `no_telpon_dokter` VALUES (3,'261-(994)651-8177'),(3,'60-(563)563-1890'),(6,'1-(702)535-7872'),(6,'55-(893)578-8871'),(7,'351-(612)846-8693'),(8,'57-(531)881-1271'),(9,'63-(393)231-8471'),(9,'66-(824)797-1868'),(11,'351-(263)603-7062'),(16,'58-(297)762-9589'),(20,'380-(509)217-4317'),(26,'51-(636)728-6548'),(30,'55-(774)558-4929'),(32,'7-(499)971-0698'),(33,'351-(756)747-9605'),(34,'33-(763)829-6137'),(34,'386-(489)803-4024'),(34,'46-(469)234-0219'),(40,'7-(399)197-4605'),(41,'48-(266)598-1698'),(43,'420-(876)343-6890'),(43,'55-(490)247-4629'),(44,'351-(634)101-4411'),(44,'7-(729)491-4695'),(45,'48-(118)708-8191'),(45,'7-(178)289-8983'),(48,'48-(642)885-3698'),(52,'63-(264)156-7896'),(55,'86-(677)262-5587'),(56,'967-(594)510-5335'),(57,'1-(775)886-3465'),(59,'62-(731)371-9167'),(59,'63-(135)799-2088'),(62,'48-(398)316-5103'),(68,'63-(564)590-1200'),(70,'420-(282)272-8685'),(70,'86-(406)503-0947'),(71,'66-(999)314-7001'),(72,'66-(699)944-0197'),(73,'7-(647)358-1844'),(76,'92-(573)499-7766'),(77,'380-(782)596-5475'),(80,'7-(111)353-5697'),(81,'60-(991)262-7920'),(81,'93-(385)816-2108'),(84,'998-(165)429-4892'),(95,'62-(496)776-2604'),(96,'86-(403)294-1602'),(97,'63-(233)469-7109'),(98,'86-(934)828-8211'),(102,'62-(862)886-1716'),(104,'351-(730)476-7594'),(105,'1-(810)673-4196'),(110,'63-(786)296-7809'),(114,'62-(668)319-1862'),(114,'686-(664)597-4742'),(117,'7-(356)889-6663'),(122,'33-(447)943-0107'),(125,'62-(664)990-8390'),(126,'92-(278)795-2602'),(128,'51-(877)257-6121'),(129,'62-(803)515-4987'),(131,'381-(434)397-3377'),(132,'86-(672)782-0686'),(132,'86-(930)681-4685'),(134,'1-(216)102-2439'),(136,'86-(165)495-5805'),(136,'86-(558)916-7616'),(138,'66-(103)877-6509'),(142,'375-(403)480-1928'),(144,'234-(223)693-0390'),(153,'82-(566)126-7979'),(158,'7-(241)434-0111'),(159,'33-(686)119-8781'),(159,'63-(734)519-3112'),(162,'52-(554)250-5533'),(164,'359-(477)959-9317'),(164,'51-(852)183-0130'),(165,'55-(882)509-7167'),(166,'1-(785)987-2065'),(168,'676-(924)698-1060'),(169,'1-(504)125-0811'),(174,'86-(652)787-2525'),(177,'58-(811)569-2480'),(177,'963-(494)290-3833'),(179,'374-(427)222-0598'),(183,'62-(644)615-6820'),(185,'7-(970)932-7472'),(187,'598-(184)688-8493'),(189,'55-(378)368-8673'),(189,'963-(178)943-3954'),(193,'216-(885)560-1965'),(193,'7-(282)469-1582'),(193,'7-(898)219-7866'),(193,'86-(928)744-4218'),(194,'222-(440)340-3558'),(195,'62-(441)803-8662'),(195,'66-(270)691-4994'),(196,'1-(713)101-8126'),(197,'86-(995)980-1011');
/*!40000 ALTER TABLE `no_telpon_dokter` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `no_telpon_pasien`
--

DROP TABLE IF EXISTS `no_telpon_pasien`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `no_telpon_pasien` (
  `ID_Pasien` int(20) NOT NULL,
  `No_Telp_Pas` varchar(25) NOT NULL,
  PRIMARY KEY (`ID_Pasien`,`No_Telp_Pas`),
  CONSTRAINT `FK_No_Telpon_Pasien_Pasien` FOREIGN KEY (`ID_Pasien`) REFERENCES `pasien` (`ID_Pasien`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `no_telpon_pasien`
--

LOCK TABLES `no_telpon_pasien` WRITE;
/*!40000 ALTER TABLE `no_telpon_pasien` DISABLE KEYS */;
INSERT INTO `no_telpon_pasien` VALUES (3,'86-(323)270-9425'),(4,'62-(764)515-9677'),(5,'47-(817)384-2959'),(7,'54-(287)409-7458'),(7,'62-(581)242-4754'),(9,'62-(360)476-9468'),(9,'680-(841)787-3067'),(11,'1-(209)200-4309'),(12,'260-(809)541-7687'),(12,'420-(831)584-0944'),(13,'420-(470)629-8210'),(13,'84-(197)159-1043'),(15,'62-(971)800-0373'),(17,'52-(566)665-2452'),(19,'1-(103)420-4315'),(23,'58-(972)984-7903'),(24,'30-(591)574-2098'),(24,'86-(138)492-3895'),(27,'62-(355)803-3743'),(29,'31-(934)152-4302'),(32,'1-(710)730-3878'),(34,'66-(732)968-3266'),(35,'227-(563)378-1612'),(38,'1-(781)136-2951'),(39,'86-(409)420-9319'),(45,'33-(310)626-5370'),(51,'62-(156)211-1239'),(52,'57-(434)260-2247'),(54,'63-(160)319-9955'),(55,'86-(336)132-9737'),(65,'46-(787)432-1817'),(65,'7-(877)355-8567'),(65,'886-(996)729-4036'),(66,'7-(212)134-1806'),(68,'56-(615)375-3367'),(73,'351-(671)940-1672'),(75,'251-(165)455-2695'),(78,'55-(607)705-7081'),(82,'46-(206)320-6497'),(83,'48-(837)401-9832'),(89,'994-(647)606-0496'),(90,'86-(502)809-0180'),(95,'1-(387)337-2995'),(95,'380-(655)113-7947'),(96,'51-(913)487-0477'),(97,'689-(324)827-8044'),(101,'46-(728)712-7424'),(102,'1-(304)937-8608'),(102,'48-(437)156-1068'),(108,'86-(421)800-9392'),(110,'52-(254)230-4706'),(110,'975-(542)848-4164'),(111,'81-(153)999-7313'),(114,'81-(521)750-2108'),(121,'1-(202)627-1577'),(121,'48-(744)821-5532'),(124,'33-(607)634-6673'),(125,'52-(291)938-3742'),(128,'62-(161)879-6389'),(128,'86-(799)844-9981'),(129,'33-(375)981-5351'),(130,'86-(386)305-1911'),(134,'380-(496)731-4293'),(137,'63-(799)603-7382'),(138,'1-(577)723-2597'),(138,'86-(364)305-7036'),(142,'255-(691)897-3377'),(144,'359-(806)310-0184'),(145,'63-(491)508-6791'),(145,'63-(665)862-1499'),(146,'86-(917)183-0670'),(147,'63-(836)458-7990'),(150,'55-(382)420-4331'),(150,'86-(597)878-6385'),(151,'7-(651)719-2106'),(153,'7-(493)509-1139'),(156,'94-(347)990-4654'),(157,'86-(887)752-1401'),(158,'34-(880)445-6342'),(164,'1-(149)333-1509'),(165,'255-(751)654-8643'),(165,'27-(781)610-7299'),(166,'502-(285)245-2397'),(169,'46-(243)327-5401'),(172,'420-(880)129-5117'),(174,'86-(442)632-7869'),(180,'33-(501)945-5409'),(180,'63-(255)261-1676'),(189,'86-(254)511-2417'),(190,'46-(770)374-5145'),(190,'86-(756)355-5599'),(191,'358-(803)542-8932'),(191,'62-(948)303-2483'),(193,'55-(854)848-1836'),(193,'63-(508)300-6369'),(194,'81-(196)616-4719'),(195,'420-(558)834-2395'),(196,'7-(164)813-2589'),(199,'86-(402)255-6840'),(200,'994-(482)186-3005');
/*!40000 ALTER TABLE `no_telpon_pasien` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `obat` (
  `Kode_Trans_Obat` int(11) NOT NULL,
  `No_Reg_Infra` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`Kode_Trans_Obat`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `obat` VALUES (1001,'1003'),(1002,'1001'),(1003,'1001'),(1004,'1002'),(1005,'1003'),(1006,'1003'),(1007,'1003'),(1008,'1003'),(1009,'1001'),(1010,'1003'),(1011,'1001'),(1012,'1001'),(1013,'1003'),(1014,'1002'),(1015,'1003'),(1016,'1002'),(1017,'1003'),(1018,'1003'),(1019,'1002'),(1020,'1003'),(1021,'1003'),(1022,'1003'),(1023,'1002'),(1024,'1001'),(1025,'1002'),(1026,'1001'),(1027,'1003'),(1028,'1003'),(1029,'1001'),(1030,'1003'),(1031,'1002'),(1032,'1003'),(1033,'1003'),(1034,'1002'),(1035,'1002'),(1036,'1003'),(1037,'1002'),(1038,'1002'),(1039,'1003'),(1040,'1001'),(1041,'1003'),(1042,'1003'),(1043,'1001'),(1044,'1002'),(1045,'1003'),(1046,'1003'),(1047,'1001'),(1048,'1001'),(1049,'1001'),(1050,'1003'),(1051,'1003'),(1052,'1003'),(1053,'1003'),(1054,'1003'),(1055,'1002'),(1056,'1003'),(1057,'1002'),(1058,'1003'),(1059,'1003'),(1060,'1003'),(1061,'1002'),(1062,'1001'),(1063,'1002'),(1064,'1003'),(1065,'1002'),(1066,'1003'),(1067,'1002'),(1068,'1003'),(1069,'1001'),(1070,'1002'),(1071,'1001'),(1072,'1001'),(1073,'1001'),(1074,'1003'),(1075,'1003'),(1076,'1003'),(1077,'1003'),(1078,'1003'),(1079,'1002'),(1080,'1003'),(1081,'1001'),(1082,'1003'),(1083,'1003'),(1084,'1003'),(1085,'1001'),(1086,'1001'),(1087,'1001'),(1088,'1002'),(1089,'1003'),(1090,'1003'),(1091,'1001'),(1092,'1001'),(1093,'1002'),(1094,'1003'),(1095,'1003'),(1096,'1002'),(1097,'1003'),(1098,'1002'),(1099,'1003'),(1100,'1003');
...
CREATE TABLE `supplies` (
  ...
  `Nama_Supplies` varchar(50) DEFAULT NULL,
  `Supplier` varchar(50) DEFAULT NULL,
...
INSERT INTO `supplies` VALUES (1001,'Alcohol','NATURE REPUBLIC CO., LTD.'),(1002,'Ethyl Alcohol','Shanghai Weierya Daily Chemicals Factory'),(1003,'zidovudine','Cipla Limited'),(1004,'nicotine','Pharmacia and Upjohn Company'),(1005,'Triclosan','SJ Creations, Inc.'),(1006,'fentanyl citrate','Cephalon, Inc.'),(1007,'Oxacillin','Sandoz Inc'),(1008,'ampicillin sodium and sulbactam sodium','Roerig'),(1009,'Alcohol','Bath & Body Works, Inc.'),(1010,'Solanum lycopersicum 4','Uriel Pharmacy Inc.'),(1011,'Ibuprofen','Freds Inc'),(1012,'topiramate','Zydus Pharmaceuticals (USA) Inc.'),(1013,'','The Clorox Company'),(1014,'warfarin sodium','Cardinal Health'),(1015,'OCTINOXATE','Elizabeth Arden, Inc'),(1016,'Nitrous Oxide','Welding & Therapy Service, Inc'),(1017,'Haloperidol Decanoate','Teva Parenteral Medicines, Inc.'),(1018,'PRIMIDONE','Global Pharmaceuticals'),(1019,'neostigmine bromide','Valeant Pharmaceuticals North America LLC'),(1020,'Allantoin','Hickory Brands Inc.'),(1021,'abatacept','E.R. Squibb & Sons, L.L.C.'),(1022,'Triclosan','ALILY (ZHANGZHOU) BATH PRODUCTS LTD.'),(1023,'Norethindrone and Ethinyl Estradiol','Northstar Rx LLC'),(1024,'Polymyxin B','X-GEN Pharmaceuticals, Inc.'),(1025,'Octinoxate and Oxybenzone','Ventura International LTD.'),(1026,'Influenza A Virus, Influenza B Virus, Histaminum h','Newton Laboratories, Inc.'),(1027,'Metaxalone','Bryant Ranch Prepack'),(1028,'Potassium Carbonate, Bryonia Alba','Paramesh Banerji Life Sciences LLC'),(1029,'Simethicone Emulsion and Simethicone','Medtech Products Inc.'),(1030,'Lamotrigine','Sandoz Inc'),(1031,'Hydrocodone Bitartrate and Acetaminophen','PD-Rx Pharmaceuticals, Inc.'),(1032,'Benzocaine and Menthol','Church & Dwight Co., Inc.'),(1033,'Capsaicin','Health Care Products'),(1034,'PLATINUM','Natural Health Supply'),(1035,'OCTINOXATE, OXYBENZONE','Avon Products, Inc.'),(1036,'Tacrolimus','Strides Arcolab Limited'),(1037,'acetaminophen and phenylephrine hydrochloride/ ace','Meda Consumer Healthcare Inc.'),(1038,'dimethicone','Insight Pharmaceuticals'),(1039,'Gabapentin','REMEDYREPACK INC.'),(1040,'zonisamide','Mylan Institutional Inc.'),(1041,'Octisalate, Oxybenzone, Avobenzone and Homosalate.','Empack Spraytech Inc.'),(1042,'Povidone-iodine','Aplicare, Inc.'),(1043,'OCTINOXATE, OXYBENZONE, OCTISALATE, AVOBENZONE','Laboratoires Clarins S.A.'),(1044,'Ibuprofen','Hannaford Brothers Company'),(1045,'diazoxide','Teva Global Respiratory Research LLC'),(1046,'Fluconazole','NorthStar Rx LLC'),(1047,'Fluconazole','PD-Rx Pharmaceuticals, Inc.'),(1048,'Acetaminophen, Diphenhydramine HCl','American Sales Company'),(1049,'imipenem and cilastatin sodium','Merck Sharp & Dohme Corp.'),(1050,'Gabapentin','REMEDYREPACK INC.'),(1051,'Terazosin','Apotex Corp.'),(1052,'niacinamide','Talmocom Co., Ltd'),(1053,'BUSPIRONE HYDROCHLORIDE','New Horizon Rx Group, LLC'),(1054,'Olanzapine','Dr.Reddy\'s Laboratories Inc'),(1055,'Zinc Oxide, Octinoxate, Octisalate','Swiss-American Products'),(1056,'Aluminum Zirconium Tetrachlorohydrex GLY','Conopco Inc. d/b/a Unilever'),(1057,'Phalaris arundinaceae','Allermed Laboratories, Inc.'),(1058,'Polyethylene Glycol 3350','Western Family Foods Inc'),(1059,'Ciprofloxacin','Actavis Pharma, Inc.'),(1060,'Clopidogrel','International Labs, Inc.'),(1061,'Preferred Plus','Kinray Inc'),(1062,'Hypericum perforatum, Phytolacca decandra, Guaiacu','Apotheca Company'),(1063,'famotidine, calcium carbonate and magnesium hydrox','McKesson'),(1064,'Diazepam','Preferred Pharmaceuticals, Inc.'),(1065,'atorvastatin calcium','Mylan Pharmaceuticals Inc.'),(1066,'Octinoxate, Oxybenzone, Titanium Dioxide','JAFRA COSMETICS INTERNATIONAL'),(1067,'SALICYLIC ACID','RITE AID CORPORATION'),(1068,'Budesonide','Preferred Pharmaceuticals, Inc.'),(1069,'Naproxen Sodium','Shopko Stores Operating Co., LLC'),(1070,'Alprazolam','AvKARE, Inc.'),(1071,'PYRITHIONE ZINC','Filo America'),(1072,'Benzocaine','CVS Pharmacy'),(1073,'Echinacea angustifolia, Hydrastis canadensis, Loma','Apotheca Company'),(1074,'THUJA OCCIDENTALIS LEAFY TWIG','Washington Homeopathic Products'),(1075,'ibuprofen','Rebel Distributors Corp'),(1076,'Fentanyl','Upsher-Smith Laboratories, Inc.'),(1077,'HYDROCODONE BITARTRATE AND ACETAMINOPHEN','McKesson Packaging Services a business unit of McK'),(1078,'Benzocaine','Group Practice Solutions, Inc.'),(1079,'SHEA BUTTER','NATURAL COSMETICS INDUSTRY LTD'),(1080,'Acetaminophen','Meijer Distribution Inc'),(1081,'NAPROXEN SODIUM','J.P. BUSINESS ENTERPRISE'),(1082,'Pecan Nut','Nelco Laboratories, Inc.'),(1083,'amoxicillin and clavulanate potassium','Physicians Total Care, Inc.'),(1084,'Oxcarbazepine','Roxane Laboratories, Inc'),(1085,'Cocklebur Xanthium strumarium','Jubilant HollisterStier LLC'),(1086,'rizatriptan benzoate','Merck Sharp & Dohme Corp.'),(1087,'Triclosan','CVS Pharmacy'),(1088,'Hydralazine Hydrochloride','Clinical Solutions Wholesale'),(1089,'Carp','Nelco Laboratories, Inc.'),(1090,'TITANIUM DIOXIDE','HANBUL COSMETICS CO., LTD.'),(1091,'Gemfibrozil','Golden State Medical Supply, Inc.'),(1092,'omeprazole','KAISER FOUNDATION HOSPITALS'),(1093,'Sodium Fluoride','Army + Air Force Exchange Service'),(1094,'Divalproex Sodium','State of Florida DOH Central Pharmacy'),(1095,'furosemide','Mylan Pharmaceuticals Inc.'),(1096,'Benztropine Mesylate','American Health Packaging'),(1097,'Mineral Oil','Major Pharmaceuticals'),(1098,'THEOPHYLLINE','Hospira, Inc.'),(1099,'Minoxidil','Watson Laboratories, Inc.'),(1100,'Aspirin','Pharmadel LLC'),(1101,'Ventilator, Continuous, Minimal Ventilatory Suppor','Sion Biotext Medical Ltd'),(1102,'Calculator, Pulmonary Function Interpretator (Diag','Nelco Laboratories, Inc.'),(1103,'Calibrator, Pressure, Gas','Matrixx Initiatives, Inc.'),(1104,'Analyzer, Gas, Oxygen, Partial Pressure, Blood-Pha','Blistex Inc.'),(1105,'Gas, Collecting Vessel','Stiefel Laboratories Inc'),(1106,'Unit, Liquid-Oxygen, Portable','Liberty Pharmaceuticals, Inc.'),(1107,'Spirometer, Diagnostic','Safeway'),(1108,'Monitor, Apnea, Home Use','Parke-Davis Div of Pfizer Inc'),(1109,'Generator, Oxygen, Portable','Carilion Materials Management'),(1110,'Monitor, Breathing Frequency','Physicians Total Care, Inc.'),(1111,'Valve, Non-Rebreathing','L\'Oreal Productos Capilares'),(1112,'Connector, Airway (Extension)','Pfizer Laboratories Div Pfizer Inc'),(1113,'Calibrator, Volume, Gas','The Great Atlantic & Pacific Tea Company'),(1114,'Algesimeter, Powered','Freedom Medical'),(1115,'Hood, Oxygen, Infant','Cardinal Health'),(1116,'Continuous Brachial Plexus Block Tray','AvPAK'),(1117,'Epidural Anesthesia Kit','Sandoz Inc'),(1118,'Meter, Airway Pressure (Inspiratory Force)','Physicians Total Care, Inc.'),(1119,'Device,Heimlich Maneuver Assist','Antares Pharma, Inc.'),(1120,'Analyzer, Gas, Argon, Gaseous-Phase','Jafra Cosmetics International Inc'),(1121,'Nebulizer, Medicinal, Non-Ventilatory (Atomizer)','Bayer HealthCare Pharmaceuticals Inc.'),(1122,'Ventilator, Emergency, Powered (Resuscitator)','Aurobindo Pharma Limited'),(1123,'Calculator, Pulmonary Function Interpretator (Diag','Aphena Pharma Solutions - Tennessee, LLC'),(1124,'Mask, Oxygen, Low Concentration, Venturi','REMEDYREPACK INC.'),(1125,'Catheters, Suction, Tracheobronchial','Rimmel Inc.'),(1126,'Set, Tubing And Support, Ventilator (W Harness)','Native Remedies, LLC'),(1127,'Tube, Bronchial (W/Wo Connector)','Rebel Distributors Corp'),(1128,'Needle, Spinal, Short Term','Energetix Corp'),(1129,'Cannula, Nasal, Oxygen','DZA Brands LLC'),(1130,'Filter, Conduction, Anesthetic','REMEDYREPACK INC.'),(1131,'Valve, Non-Rebreathing','Apotheca Company'),(1132,'Chair, Posture, For Cardiac And Pulmonary Treatmen','Cover FX Skin Care, Inc.'),(1133,'Needle, Spinal, Short Term','Newton Laboratories, Inc.'),(1134,'Monitor, Apnea, Facility Use','Deseret Biologicals, Inc.'),(1135,'Mask, Gas, Anesthetic','American Sales Company'),(1136,'Attachment, Breathing, Positive End Expiratory Pre','Hikma Pharmaceutical'),(1137,'Hood, Oxygen, Infant','Preferred Pharmaceuticals, Inc'),(1138,'Plethysmograph, Pressure','Preferred Pharmaceuticals, Inc'),(1139,'Needle, Spinal, Short Term','Par Pharmaceutical, Inc.'),(1140,'Laryngoscope, Rigid','Physicians Total Care, Inc.'),(1141,'Monitor, Airway Pressure (Includes Gauge And/Or Al','Baoying County Fukang Medical Appliance Co., Ltd.'),(1142,'Spinal Anesthesia Kit','Hannaford Brothers Company'),(1143,'Spacer, Direct Patient Interface','Cryo Weld Corporation'),(1144,'Continuous Brachial Plexus Block Tray','Wakefern Food Corporation'),(1145,'Nebulizer, Medicinal, Non-Ventilatory (Atomizer)','Unit Dose Services'),(1146,'Monitor, Air Embolism, Ultrasonic','Unit Dose Services'),(1147,'Meter, Airway Pressure (Inspiratory Force)','Jubilant HollisterStier LLC'),(1148,'Clip, Nose','American Sales Company'),(1149,'Ventilator, Continuous, Minimal Ventilatory Suppor','Proficient Rx LP'),(1150,'Spinal Epidural Anesthesia Kit','Kolmar Korea Co Ltd'),(1151,'Ventilator, Continuous, Minimal Ventilatory Suppor','Physicians Total Care, Inc.'),(1152,'Anesthesia Kit','REMEDYREPACK INC.'),(1153,'Stimulator, Nerve, Ac-Powered','KMART CORPORATION'),(1154,'Glossopharyngeal Anesthesia Kit','Physicians Total Care, Inc.'),(1155,'Mask, Scavenging','Cardinal Health (Leader)'),(1156,'Tube, Thorpe, Uncompensated','CVS PHARMACY'),(1157,'Monitor, Airway Pressure (Includes Gauge And/Or Al','Sanum Kehlbeck GmbH & Co. KG'),(1158,'Condenser, Heat And Moisture (Artificial Nose)','Premier Value (Chain Drug Consortium, LLC)'),(1159,'Flowmeter, Tube, Thorpe, Back-Pressure Compensated','Physicians Total Care, Inc.'),(1160,'Needle, Spinal, Short Term, Reprocessed','A-S Medication Solutions LLC'),(1161,'Spinal Epidural Anesthesia Kit','UDL Laboratories Inc'),(1162,'Analyzer, Gas, Helium, Gaseous-Phase','Cardinal Health'),(1163,'Cylinder, Compressed Gas, And Valve','Mylan Institutional Inc.'),(1164,'Chair, Posture, For Cardiac And Pulmonary Treatmen','Sciele Pharma, Inc.'),(1165,'Condenser, Heat And Moisture (Artificial Nose)','Rebel Distributors Corp'),(1166,'Epidural Anesthesia Kit','Western Family Foods, Inc.'),(1167,'Nebulizer, Medicinal, Non-Ventilatory (Atomizer)','Aurobindo Pharma Limited'),(1168,'Non-Bronchoscopic Bronchoalveolar Lavage Catheter','Clinical Solutions Wholesale'),(1169,'Flowmeter, Nonback-Pressure Compensated, Bourdon G','Nelco Laboratories, Inc.'),(1170,'Blood Specimen Collection Kit (Excludes Hiv Testin','REMEDYREPACK INC.'),(1171,'Needle, Conduction, Anesthesia, Reprocessed','Mylan Pharmaceuticals Inc.'),(1172,'Applicator (Laryngo-Tracheal), Topical Anesthesia','Mylan Pharmaceuticals Inc.'),(1173,'Cylinder, Compressed Gas, And Valve','CVS Pharmacy'),(1174,'Monitor, Oxygen, Cutaneous, For Infant Not Under G','ARMY AND AIR FORCE EXCHANGE SERVICE'),(1175,'Impedance Measuring Device Utilizing Oscillation T','AAA Pharmaceutical, Inc.'),(1176,'Unit, Liquid-Oxygen, Portable','REMEDYREPACK INC.'),(1177,'Percussor, Powered-Electric','Jiangsu Province JianErKang Medical Dressing Co. ,'),(1178,'Analyzer, Gas, Carbon-Monoxide, Gaseous-Phase','Beacon Promotions, Inc.'),(1179,'Calibrator, Volume, Gas','Physicians Total Care, Inc.'),(1180,'Laryngoscope, Rigid','Pfizer Consumer Healthcare'),(1181,'Calculator, Predicted Values, Pulmonary Function','Meijer Distribution Inc'),(1182,'Meter, Airway Pressure (Inspiratory Force)','Good Neighbor Pharmacy'),(1183,'Stool, Anesthesia','Cardinal Health'),(1184,'Strap, Head, Gas Mask','Major Pharmaceuticals'),(1185,'Spinal Anesthesia Kit','Natures Sunshine Products, Inc.'),(1186,'Tube Tracheostomy And Tube Cuff','Nelco Laboratories, Inc.'),(1187,'Tracheal Suction Set','Endo Pharmaceuticals'),(1188,'Analyzer, Gas, Carbon-Monoxide, Gaseous-Phase','Select Brand'),(1189,'Chair, Posture, For Cardiac And Pulmonary Treatmen','Physicians Total Care, Inc.'),(1190,'Cabinet, Table And Tray, Anesthesia','American Health Packaging'),(1191,'Attachment, Intermitant Mandatory Ventilation (Imv','Mylan Pharmaceuticals Inc.'),(1192,'Cylinder, Compressed Gas, And Valve','Sanum Kehlbeck GmbH & Co. KG'),(1193,'Apparatus, Gas-Scavenging','Uriel Pharmacy Inc.'),(1194,'Cylinder, Compressed Gas, And Valve','Fred\'s Inc.'),(1195,'Device,Heimlich Maneuver Assist','Wyeth Pharmaceuticals Inc., a subsidiary of Pfizer'),(1196,'Mask, Ventilator, Non-Continuous, Reprocessed','Conopco Inc. d/b/a Unilever'),(1197,'Hood, Oxygen, Infant','Watson Laboratories, Inc.'),(1198,'Connector, Airway (Extension)','MSD Consumer Care, Inc.'),(1199,'Protector, Dental','Boscia LLC'),(1200,'Tube, Tracheal, Reprocessed','Preferred Pharmaceuticals, Inc');
...
-- Dump completed on 2017-04-18 10:39:05
